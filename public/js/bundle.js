    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          if (_context.t0.response.data.message.startsWith('User validation failed: passwordConfirm')) {
            (0, _alerts.showAlert)('error', 'Passwords are not the same!');
          } else if (_context.t0.response.data.message.startsWith('E11000')) {
            (0, _alerts.showAlert)('error', 'Email already exists!');
          } else {

...
// if there's only the field images, the implementation will be like this: 
...
exports.getToursWithin = catchAsync( async (req, res, next) => {
  ...
  if(!lat || !lng){
    return new next(AppError('Please provide latitude and longitude in the format: lat,lng', 400))
  }
